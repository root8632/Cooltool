document.addEventListener('DOMContentLoaded', () => {
    ...
    game = {
        ...
        drawScore: function() {
            ...
            context.font = (canvas.height / 2) + 'px Impact, sans-serif';
    ...
    food = {
        ...
        set: function() {
            ...
            food.x = (Math.ceil(Math.random() * (canvas.width / snake.size - 1)) * snake.size) + snake.size / 2;
            food.y = (Math.ceil(Math.random() * (canvas.height / snake.size - 1)) * snake.size) + snake.size / 2;
        },
